      ...
      <section className="relative py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 mb-20">
            ...
            <Card id="mobile" className="bg-slate-800/50 border-slate-700 hover:border-blue-600/50 transition-all duration-300 overflow-hidden group">
            ...
            {/* Web Development */}
            <Card id="web" className="bg-slate-800/50 border-slate-700 hover:border-purple-600/50 transition-all duration-300 overflow-hidden group">
