    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          {/* AI & Automation Setup */}
          <FadeIn delay={0.4}>
            <div id="ai-setup" className="mt-20">
              <AnimatedCard>
                <Card className="bg-[#1c1c26] border-white/10 hover:border-[#0EA5E9]/50 transition-all duration-500 overflow-hidden group">
                  <div className="absolute top-0 right-0 w-64 h-64 bg-linear-to-br from-[#0EA5E9]/10 to-transparent rounded-full blur-3xl" />
                  <div className="relative grid lg:grid-cols-2 gap-8 p-8">
                    <div className="space-y-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h2 className="text-2xl font-bold text-white font-space-grotesk">AI & Automation Setup</h2>
                          <div className="flex flex-col">
                            <p className="text-[#0EA5E9] font-semibold text-lg">$99 one-time (local)</p>
                            <p className="text-[#06B6D4] font-semibold text-sm">$99 + $29/mo (VPS option)</p>
                          </div>
                        </div>
                      </div>

                      <p className="text-white/80 text-lg leading-relaxed font-light">
                        Your own private AI workspace — ChatGPT-like interface running on your computer or dedicated VPS.
                        No subscriptions, no data harvesting. You own everything.
                      </p>

                      <div className="space-y-3">
                        {[
                          "Ollama + Open WebUI (private ChatGPT alternative)",
                          "Setup on your computer or managed VPS",
                          "One open-source model installed & configured",
                          "60-90 min live setup & training session",
                          "7 days email support after go-live",
                          "VPS: Custom domain + SSL + monthly monitoring"
                        ].map((feature, index) => (
                          <div key={index} className="flex items-start">
                            <CheckCircle weight="duotone" className="h-6 w-6 text-[#0EA5E9] mr-3 shrink-0 mt-0.5" />
                            <span className="text-white/80">{feature}</span>
                      ...
                      <div className="relative w-full max-w-sm">
                        ...
                        <div className="relative bg-[#0d0d12] rounded-2xl border border-white/10 p-8 text-center">
                          ...
                          <p className="text-white/60 text-sm">
                            Run AI locally or on your own VPS. No cloud APIs, no data leaving your environment.
                          </p>
                        </div>
                      </div>
                    </div>
