...
export const metadata: Metadata = {
  ...
  description: "Joe runs a 16-agent production stack for his own business. He's client zero — everything JTS builds, he uses himself first.",
  alternates: {
    canonical: '/about',
  },
  openGraph: {
            ...
            <div className="space-y-8">
              ...
              <FadeIn delay={0.2}>
                <p className="text-xl sm:text-2xl text-white/80 leading-relaxed font-light">
                  Joe doesn&apos;t sell tools he read about. He runs a 16-agent production stack for his own business —
              ...
              <FadeIn delay={0.25}>
                <p className="text-lg text-white/60 leading-relaxed font-light">
                  Former Waymo ops manager. Full-stack developer. Now building private AI and custom systems
              ...
              <AnimatedCard>
                <Card className="bg-[#1c1c26] border-white/10 hover:border-[#2dd4bf]/50 transition-all duration-500 h-full">
                  <CardContent className="pt-8 pb-8 text-center">
                    ...
                    <p className="text-white/70 leading-relaxed">
                      Runs a 16-agent production stack for JTS operations right now. Not theory — a live system handling real business tasks around the clock.
                    </p>
                  </CardContent>
                </Card>
              </AnimatedCard>
            ...
            {[
              {
                ...
                description: "Joe runs a 16-agent production stack for JTS right now. Every system he sells to clients, he battle-tested on his own business first. No vapor, no demos — real production systems."
              },
              {
