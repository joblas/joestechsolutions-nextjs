  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center">
        <div className="w-2.5 h-2.5 rounded-none bg-primary ring-4 ring-primary/20 shrink-0 mt-1" />
        <div className="w-px flex-1 bg-gradient-to-b from-primary/30 to-transparent" />
      </div>
      <div className="pb-2">
        <span className="text-primary text-xs font-mono font-semibold">{time}</span>
