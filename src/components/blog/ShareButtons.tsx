...
export function ShareButtons({ url, title }: ShareButtonsProps) {
  ...
  const shareUrl = `https://joestechsolutions.com${url}`;
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-sm text-gray-500 dark:text-white/50">Share:</span>
      ...
      >
        <svg className="w-5 h-5 text-gray-600 dark:text-white/70" fill="currentColor" viewBox="0 0 24 24">
